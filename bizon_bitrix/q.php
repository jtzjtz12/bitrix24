...
$webId="3918:pp_new*2022-02-15T19:00:02";
...
$created=str_replace('-','.',str_replace('*',' ',str_replace('T',' ',stristr($webinarId,'*'))));
...
echo '<br>';
echo $created2[2].".".$created2[1].".".$created2[0].str_replace('T',' ',stristr($webinarId,'T')).'<br>';
echo '<br>';
...
"UF_CRM_1617967842" => date("m-d-Y H:i:s", $secondsN),
"UF_CRM_1617967897" => date("m-d-Y H:i:s", $secondsC),
...
"UF_CRM_1617966386"=> "len",//$data1['len']
"COMMENTS" => $comments,
	  "CATEGORY_ID" => 8,
        "TYPE_ID" => "SALE", 
        "STAGE_ID" => "C8:NEW",                
